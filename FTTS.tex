...
The two message servers of $RC2$ are basically null handlers that do nothing, i.e., there are no internal actions caused by statements like assignments, and no \texttt{send}  or \texttt{delay} statements.
