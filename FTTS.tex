...
The constructor of $RC1$ puts the message $m1$ in the queue of $RC1$. 

Figure \ref{fig::FTTSandTTS}.a shows the TTS generated for the model in Listing \ref{src::FTTS-actor-model}. In $time=0$ we have the message $m1$ in the queus of $r1$.
...
\label{fig::TTS}
  \centering
  \small{
   \includegraphics[width=.18\textwidth]{TTSCorrect.pdf}
  }
}
\qquad
\subfigure[FTTS]{
