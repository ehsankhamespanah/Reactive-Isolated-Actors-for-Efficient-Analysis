...
For generating the first type of transition, the effect of \Fatem{topology on the execution of the communication statement, like broadcast, on the topology is considered.
\fixme{How a communication statement can affect the topology? I thought the first type of transitions do not affect topology.
Maybe you mean the other way around? affect of topology on the execution of the communication statement?} \Fatem{Yes, I mean the other way, I had corrected it, and I taught you had changed it :). This one is correct to me: affect of topology on the execution of the communication statement}
