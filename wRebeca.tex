...
To reason about small-sized networks by model checking technique, the transition system of a model is generated. The global states %of a semantic model
...
n \\
2 \\
\end{pmatrix}$ possible uni-directional links among them, and as each link can be up/down $2^{(n^2-n)}$ possible topologies, %and by assuming the links are symmetrical, 
