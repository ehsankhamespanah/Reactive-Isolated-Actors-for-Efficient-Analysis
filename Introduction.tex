...
\Marjan{Here I should add: 
Rebeca is designed to be faithful to ... At the same time we considered analyzability and so keeping things as simple as possible.
Theories and tools are developed (cite papers). Rebeca is used in different applications (cite papers), and each application we devised new techniques mostly using the adavntage of isolation.}
